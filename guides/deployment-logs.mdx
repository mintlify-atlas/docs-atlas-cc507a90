---
title: "View Real-Time Deployment Logs and Build Output Live"
sidebarTitle: "Deployment Logs"
description: "Stream live build output during a deployment and access persisted logs for completed or failed builds via the dashboard or the API."
---
