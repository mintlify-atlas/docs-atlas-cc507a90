...
<Steps>
  ...
  <Step title="Browse and select a repository">
    The dashboard fetches your repositories from `GET /api/v1/repository` using paginated requests (10 repos per page). Use the search bar to filter by repository name or full name (e.g. `owner/repo`). Click the **Import** button next to the repository you want to deploy.
