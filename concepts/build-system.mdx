...
description: "Learn how Deploy Your App auto-detects your framework and package manager, selects the right Dockerfile template, and handles static vs. dynamic deployments."
---
...
Each combination of framework and package manager maps to a pre-built Dockerfile template stored under `infra/docker/`:
...
| Vite | bun | `infra/docker/vite/Dockerfile.bun` |
| Vite | npm | `infra/docker/vite/Dockerfile.npm` |
| Vite | pnpm | `infra/docker/vite/Dockerfile.pnpm` |
| Vite | yarn | `infra/docker/vite/Dockerfile.yarn` |
