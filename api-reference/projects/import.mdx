...
description: "Create a new project from a GitHub repository and trigger the first deployment. Registers a push webhook and encrypts all supplied environment variables."
---
