---
title: "GET /api/v1/projects — List All Projects for a User"
sidebarTitle: "List Projects"
description: "Retrieve all projects owned by the authenticated user. Each object includes repository info, build configuration, deployment URL, and custom domain status."
---
