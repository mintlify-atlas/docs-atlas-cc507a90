---
title: "DELETE /api/v1/projects/:id — Remove a Project"
sidebarTitle: "Delete Project"
description: "Permanently delete a project and all of its associated deployments and environment variables. This action cannot be undone."
---
